...
<?php else: ?>
	...
	<fieldset class="set">
		...
		<fieldset>
			<label for="bg_color"><?php _e('Background Color', CI_DOMAIN); ?></label>
	...
	<fieldset class="set">
		...
		<label for="bg_image"><?php _e('Upload your background image', CI_DOMAIN); ?></label>
		<input id="bg_image" type="text" size="60" name="<?php echo THEME_OPTIONS; ?>[bg_image]" value="<?php echo $ci['bg_image']; ?>" class="uploaded"/>
		...
		<fieldset>
			...
			<label for="bg_image_repeat"><?php _e('Repeat background', CI_DOMAIN); ?></label>
			<select id="bg_image_repeat" name="<?php echo THEME_OPTIONS; ?>[bg_image_repeat]">
	...
	<fieldset class="set">
		...
		<fieldset>
			...
			<label for="bg_image_horizontal"><?php _e('Background Horizontal Placement', CI_DOMAIN); ?></label>
			<select id="bg_image_horizontal" name="<?php echo THEME_OPTIONS; ?>[bg_image_horizontal]">
		...
		<fieldset>
			...
			<label for="bg_image_vertical"><?php _e('Background Vertical Placement', CI_DOMAIN); ?></label>
			<select id="bg_image_vertical" name="<?php echo THEME_OPTIONS; ?>[bg_image_vertical]">
