...
<?php else: ?>
	<fieldset class="set">
		...
		<label for="archive-no"><?php _e('Number of latest posts', CI_DOMAIN); ?></label>
		<input id="archive-no" type="text" size="60" name="<?php echo THEME_OPTIONS; ?>[archive_no]" value="<?php echo $ci['archive_no']; ?>" />
	</fieldset>
	<fieldset>
		...
		<fieldset>
			...
			<label for="archive-week"><?php _e('Display weekly archive', CI_DOMAIN); ?></label>	
		</fieldset>
		<fieldset>
			...
			<label for="archive-month"><?php _e('Display monthly archive', CI_DOMAIN); ?></label>	
		</fieldset>
		<fieldset>
			...
			<label for="archive-year"><?php _e('Display yearly archive', CI_DOMAIN); ?></label>	
		</fieldset>
	</fieldset>
<?php endif; ?>