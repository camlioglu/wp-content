...
<div id="box-container">
    <div id="entry-listing" class="group">
        ...
        if (is_front_page() && is_active_sidebar('public_side')) {
            ?>

            <article id="intro" class="entry box">
                <div class="entry-content-cnt">
                    <?php dynamic_sidebar('public_side'); ?>
                </div>
            </article>
        ...
        <article id="post-<?php the_ID();?>" <?php post_class('entry box format-' . $format); ?>>
            <div class="entry-content-cnt">
                ...
                <div class="entry-content">
                    <a href="<?php the_permalink(); ?>"
                       title="<?php echo __('Permalink to', CI_DOMAIN) . ' ' . esc_attr(get_the_title()); ?>">
                        <?php ci_e_content(); ?>
                    </a>
                </div>
                ...
                <div class="entry-content">
                    <blockquote cite="<?php echo $url; ?>">
                        ...
                        <cite><a
                                href="<?php echo $url; ?>"><?php echo get_post_meta($post->ID, 'ci_format_quote_credit', true); ?></a></cite>
                    </blockquote>
                </div>
            ...
            <div class="entry-desc">
                ...
                <h1><a href="<?php the_permalink(); ?>"
                       title="<?php echo __('Permalink to', CI_DOMAIN) . ' ' . esc_attr(get_the_title()); ?>"><?php the_title(); ?></a>
                </h1>
                <?php endif; ?>
                            ...
                            <div class="jp-type-single">
                                <div class="jp-gui jp-interface">
                                    <ul class="jp-controls">
                                        <li><a href="#" class="jp-play" tabindex="1"><?php _e('Play', CI_DOMAIN); ?></a>
                                        </li>
                                        <li><a href="#" class="jp-pause"
                                               tabindex="1"><?php _e('Pause', CI_DOMAIN); ?></a></li>
                                    </ul>
                ...
                <div class="entry-meta group">
                    ...
                    <a class="entry-permalink" href="<?php the_permalink(); ?>"
                       title="<?php echo __('Permalink to', CI_DOMAIN) . ' ' . esc_attr(get_the_title()); ?>"><?php the_title(); ?></a>
                </div>
            </div>
        </article>
