...
function CI_DisplayTweetsEnqueue()
{
	if (is_active_widget(false, false, 'ci_twitter_widget'))
	{
		wp_enqueue_script('wp_twitter', get_bloginfo('template_url').'/js/twitter_script.js', array(), false, false);
	}
}
add_action('wp_enqueue_scripts', 'CI_DisplayTweetsEnqueue');
