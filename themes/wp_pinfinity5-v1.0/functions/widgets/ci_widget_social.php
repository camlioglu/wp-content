<?php class CI_Social extends WP_Widget {

 function CI_Social(){
  $widget_ops = array('description' => 'Social Icons widget placeholder');
 ...
 function form($instance){
  	$instance = wp_parse_args( (array) $instance, array('title'=>'') );
 		...
 		echo "<p>".__('This widget is a placeholder for Social Media icons. You may configure those icons from the <a href="themes.php?page=ci_panel.php">CSSIgniter\'s panel</a>, under the <strong>Social Options</strong> tab.', CI_DOMAIN)."</p>";
 		echo '<p><label>' . __('Title:', CI_DOMAIN) . '</label><input id="' . $this->get_field_id('title') . '" name="' . $this->get_field_name('title') . '" type="text" value="' . $title . '" class="widefat" /></p>';
 } // form
