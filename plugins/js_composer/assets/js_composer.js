...
jQuery(document).ready(function($) {
	...
	*/
	...
	if ( $("#wpb_visual_composer").length == 1 ) {
		if($('.wpb_js_composer_group_access_show_rule').val()!='only' && $('.wpb_js_composer_group_access_show_rule').val()!='no') $('div#titlediv').after('<p class="composer-switch"><a class="wpb_switch-to-composer button-primary" href="#">' + i18nLocale.main_button_title +'</a></p>');
